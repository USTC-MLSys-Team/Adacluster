...
from triton_kernel.flashinfer_cluster_sparse_attn import flashinfer_cluster_sparse_attn
__all__ = ['WanModel']
...
class WanSelfAttention(nn.Module):
    ...
    def forward(self, x, seq_lens, grid_sizes, freqs, topk_num: int = 128, q_kernel_num: int = 100, kv_kernel_num: int = 500):
        ...
        #if True :# or self.layer_idx<210:  # 注意：层索引从0开始，所以第1层是0，第16层是15
        if False:           # 对于第1层和第16层，直接返回完整的注意力输出
