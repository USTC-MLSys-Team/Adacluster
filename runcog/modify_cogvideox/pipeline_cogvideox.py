...
class CogVideoXPipelineSparse(DiffusionPipeline, CogVideoXLoraLoaderMixin):
    r"""
    ...
    def decode_latents(self, latents: torch.Tensor) -> torch.Tensor:
        ...
        # 保持 latents 的原始数据类型，与 VAE 权重类型匹配
    ...
    def __call__(
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            ...
            for i, t in enumerate(timesteps):
                ...
                if set_skip == False and i >= self._num_timesteps * self.skip_ratio:
                    set_skip = True
                    self.transformer.set_attn_processor(processor=self.sparse_attn_processor)
